...
function GetAllMusics() {
  ...
  useEffect(() => {
    if (!localStorage.getItem(user1token) && !current.current) {
      allMusic();
  ...
  const [musicFilterChange, setMusicFilterChange] = useState(true);
  //  //! Filter Song...
  const onFilterChange = (e) => {
    const sortType = e.target.value;
    sortMusic(sortType);
    setMusicFilterChange(!musicFilterChange);
  }

  useEffect(() => {
    setMusic(musicData);
  }, [musicData, musicFilterChange]);
      ...
      <div className="mb-5">
        <div className="mr-2 ml-2 grid place-items-center">
          ...
          <div className="flex flex-col justify-evenly md:flex-row w-[100%]">
            ...
            <div className="">
              {/* //! Features... */}
              <div className="ring-1 ring-gray-50 md:shadow-md md:w-[30vw] rounded-md">
